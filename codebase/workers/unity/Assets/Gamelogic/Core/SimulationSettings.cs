...
namespace Assets.Gamelogic.Core
{
    public static class SimulationSettings
    {
		...
		//public static readonly float OrderGenerationInterval = 2.5f;
		...
		public static readonly float OrderGenerationInterval = 30f;
		...
		public const float TruckCostConstant = 2 * MetreToMiles * FuelCostPerGallon / TruckMilesPerGallon;
