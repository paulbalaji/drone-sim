...
To do find out more about the inner workings of our simulated delivery networks, we implemented a method in the Controller that prints a log of important data every 60 seconds. To transfer this data into a format we can perform analysis on, we have implemented a browser-based tool that iterates through the logger view and extracts the logged metrics to a local file.
