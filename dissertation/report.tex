...
Before we can define a revenue model for our delivery network, we must improve the Order Generator to generate a greater variety of delivery requests. Packages being delivered by drones will vary in size, weight and priority, just like current the delivery market, and the DeliveryHandler schema needs to upgraded (Appendix D) to support this new properties of a delivery request.
...
% As higher priority requests will generate more revenue than lower priority requests, we must provide this information
