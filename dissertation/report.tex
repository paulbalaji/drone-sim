...
We assert that the following comparisons utilise data taken from simulations based on the world defined by the original, smaller London snapshot.
...
\subsubsection{Out for Delivery Time}
