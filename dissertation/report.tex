...
\newpage
\section{TODO: Core Prefab Creation}
...
\begin{figure}[!hbpt]
 ...
 \begin{tikzpicture}[node distance = 2cm, auto]
     ...
     \node [block, right of=controller, node distance=3cm] (globallayer) {Global Layer};
     \node [block, right of=globallayer, node distance=3cm] (bitmap) {Bitmap};
     ...
     % Draw edges
     \path [line] (controller) -- (globallayer);
     \path [line] (globallayer) -- (bitmap);
