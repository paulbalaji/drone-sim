...
\begin{figure}[!hbpt]
 ...
 \begin{tikzpicture}[node distance = 2cm, auto]
     ...
     \node [cloud, below of=controller1, node distance=3cm] (drone1) {Drones};
     \node [cloud, below of=controller2, node distance=3cm] (drone2) {Drones};
     \node [cloud, below of=controller3, node distance=3cm] (drone3) {Drones};
     % \node [cloud, left of=globallayer, node distance=5cm] (checknfz) {Check No Fly Zones};
     % \node [block, below of=checknfz, node distance=3cm] (bitmap) {Bitmap};
     % \node [cloud, left of=init] (expert) {expert};
     % \node [cloud, right of=init] (system) {system};
