...
It would be beneficial to be able to show that simulations have been run using different drone scheduling algorithms, especially the one based on the QoS value curve. The project can be considered a success if this particular scheduling algorithm yielded greater profits than previously defined scheduling algorithms did.
